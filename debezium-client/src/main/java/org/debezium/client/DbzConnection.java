...
final class DbzConnection implements Database {
    ...
    private static ChangeStatus changeStatus( Message.Status messageStatus ) {
        switch ( messageStatus ) {
            case SUCCESS: return ChangeStatus.OK;
            case PATCH_FAILED: return ChangeStatus.PATCH_FAILED;
            case DOES_NOT_EXIST: return ChangeStatus.DOES_NOT_EXIST;
        }
    ...
    private static <I extends Identifier,T extends Identified<I>> Changed<I,T> changed( ChangeStatus status, I id, T target, Patch<I> patch, Collection<String> failureReasons ) {
