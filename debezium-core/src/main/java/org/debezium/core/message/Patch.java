...
/**
 * A set of {@link Operation operations} applied to a single identified object. A patch is created by {@link #create creating} an
 * {@link Editor editor} for the target, recording one or more
