...
public interface Debezium {
    ...
    static interface Configure {
        ...
        /**
         * Specify the amount of time that Debezium will wait for {@link #acknowledgement(Acknowledgement) acknowledgement}
         * of requests before reporting an error.
         ...
         * will be refreshed after every request (not recommended); if positive, the metadata will be refreshed periodically
         * @param unit the time unit; must not be null
         * @return this instance for chaining together methods; never null
         */
    ...
    /**
     * An immutable representation of a single Debezium {@link Client} configuration.
     */
    ...
    static interface Client {
         ...
         * @throws ConnectionFailedException if there was an error connecting to the given database with the given username
         */
